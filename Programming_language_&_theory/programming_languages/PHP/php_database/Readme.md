...
PHP offers several MySQL drivers and plugins for accessing and handling MySQL. Examples of compatible database servers are MariaDB Server,MySQL Server,Percona Server for MySQL, and TiDB.
