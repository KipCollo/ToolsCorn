...
Types of method:-
- Predefined methods e.g print()
- User defined methods

Syntax:-

access_modifier optional_specifiers return_type function_name(...parameters)throws InturruptedException{
   //statements
}
...
A method that calls itself is called `recursive method` and this technique is known as recursion.
Syntax:-
