...
Normal Flow - The default display layout of elements when no CSS has beed applied.
- *Block & Inline elements.*
An Inline element, such as link can be displayed inside of a block element.
