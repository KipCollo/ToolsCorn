...
10. Angular v12 (May 2021) - Angular 12 continued the focus on making the framework more modern
    ...
    - Introduced Nullish Coalescing.
    - Introduction to inner styling.
    - ng build defaults to production.No more --prod flag.
...
13. Angular 15 (November 2022) - Angular 15 improved the framework with
    ...
    - Introduction of Vite in dev buld.
    - Moved from karma to webtestrunner,Jest
    - Introduce Hydration behaviour.
    - ngSrc introduced
14. Angular 16 (2023) - Angular 16 focused on
    ...
    - CLI Enhancements: Further optimizations in the Angular CLI, improving overall developer experienc
    - Hydration(Dev preview)
    - Introduced Signals.
15. Angular 17 (2023) - Angular 17 continued to improve the ecosystem with
    - Improved Hydration Support: Better support for server-side rendering.Stable
    - Server-Side Rendering Tools: Enhanced tools for easier SSR integration.
    - Inroduced angular.dev
    - New Control flow syntax:- @if, @for, @switch
    - Esbuild and vite is enabled by default.
...
16. Angular 18 (2024) - Angular 18 focuses on:-
    ...
    - Experimental API to disable zones.
    - Enhanced support for hydration in devtools
    - Hydration support for Angular Material
    - Hydrating i18n blocks
    - Material 3 Theming API stable.
17. Angular 19:-
    - Standalone became default.
    - Signal & Computed are stable.
    - Introduce resource API
    - Intoduce mat.theme in Angular material.
...
This will cause an error - Cannot read property 'name' of null.
There are two solutions for this:-

1. Using *ngIf directive
2. Using safe traversal operator
