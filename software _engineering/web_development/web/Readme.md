...
Bulletin board system – Type of computer server system
Link rot – URLs ceasing to function
Site map – List of pages of a web site
Web content management system – Content management system specifically for web content
Web design – Creation and maintenance of websites
Web development tools – Software used to help develop a website or web application
Web framework – Software framework to support the development of websites
Web hosting service – Service for hosting websites
Web template system – System in web publishing
Website governance – Systems and policies to maintain websites
World Wide Web Consortium – International standards organization

1. Web 1.0 - Static web pages
2. web 2.0 - Dynamic web apps.
3. Web 3.0 - Customized data, AI driven.

A `website`, or `web site,` is any web page whose content is identified by a common domain name and is published on at least one web server. Websites are typically dedicated to a particular topic or purpose, such as news, education, commerce, entertainment, or social media. Hyperlinking between web pages guides the navigation of the site, which often starts with a home page.
All publicly-accessible websites collectively constitute the World Wide Web, which is accessed via the Internet. There are also private websites that can only be accessed on a private network, such as a company's internal website for its employees. Users can access websites on a range of devices, including desktops, laptops, tablets, and smartphones. The app used on these devices is called a web browser.
...
Websites provide static content for users to browse.Web Applications allow users to interact with data and perform tasks.


*HTML Basics* - HTML stands for HyperText Markup Language. It is used on the frontend and gives the structure to the webpage which you can style using CSS and make interactive using JavaScript.
...
*CSS Basics* - CSS or Cascading Style Sheets is the language used to style the frontend of any website. CSS is a cornerstone technology of the World Wide Web, alongside HTML and JavaScript.
Visit the following resources to learn more:
...
2. E-commerce: products or services are purchased directly through the website
3. Advertising products or services available at a brick-and-mortar business
4. Freemium: basic content is available free, but premium content requires a payment (e.g., WordPress website, it is an open-source platform to build a blog or website).
5. Some websites require user registration or subscription to access the content. Examples of subscription websites include many business sites, news websites, academic journal websites, gaming websites, file-sharing websites, message boards, Web-based email, social networking websites, websites providing real-time stock market data, as well as sites providing various other services.
...
- Communication:- Polling, Web sockets
- HTTPs & SSL
- Caching & Compression
